...
using Rolodex.Lib.Utils.Filters;
...
namespace Rolodex.Lib.Utils.Helpers
{
    public static class PaginationHelper
    {
        ...
        public static PagedResponse<T> CreatePagedReponse2<T>(T pagedData, PaginationFilter validFilter, int totalRecords, IUriService uriService, string route)
        {
